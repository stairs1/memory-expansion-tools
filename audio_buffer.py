...
class AudioBuffer():
    ...
    def __init__(self, notify=noop, notify_obj=None):
        # file buffer
        self.android = False
        ...
        self.notification_callback_object = notify_obj
    ...
    def send_notification(self):
        ...
        """
        thread = threading.Thread(
            target=self.notification_callback,
            args=[],
            kwargs={}
        )
        thread.start()
